      ...
      <aside className="w-64 bg-sidebar flex flex-col">
        ...
        <div className="p-6">
          <div className="bg-card rounded-xl p-4 w-24 h-24 mx-auto flex items-center justify-center shadow-md">
            <div className="text-center">
              <span className="text-primary text-2xl font-script">Sweet</span>
              <div className="text-xs font-bold text-secondary">BAKERY</div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          <button
            ...
            className="bg-card text-foreground px-6 py-2 rounded-full font-medium hover:bg-muted transition-colors"
          >
            Log out
          </button>
        </div>
